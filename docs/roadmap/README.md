...
```mermaid
pie title Tasks completed (135 tasks, backlog aside)
    "Done" : 118
    "Pending" : 16
    "Partial" : 1
...
| 16 | [The screens phase 11 never reached](phase-16-session-screens.md) | 9 | 1 | 🟨 90% |
| **Total** (Phase 10 aside) | | **118** | **17** | **🟢 87%** |
