...
```mermaid
pie title Tasks completed (134 tasks, backlog aside)
    "Done" : 117
    "Pending" : 16
    "Partial" : 1
...
| 16 | [The screens phase 11 never reached](phase-16-session-screens.md) | 8 | 1 | 🟨 89% |
| **Total** (Phase 10 aside) | | **117** | **17** | **🟢 87%** |
