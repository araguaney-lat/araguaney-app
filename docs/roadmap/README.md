...
```mermaid
pie title Tasks completed (133 tasks, backlog aside)
    "Done" : 116
    "Pending" : 16
    "Partial" : 1
...
| 16 | [The screens phase 11 never reached](phase-16-session-screens.md) | 7 | 1 | 🟨 88% |
| **Total** (Phase 10 aside) | | **116** | **17** | **🟢 87%** |
