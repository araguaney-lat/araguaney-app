...
| 12 | Reports for the center | Seven report routes scoped by `tenant_scope`. **Category is done** (Phase 03, task 5); activity, shrinkage, summary, countries, by-center and the CSV export are not. | 🟠 Medium | 🟨 Partial |
