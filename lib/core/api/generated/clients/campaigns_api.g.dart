...
class _CampaignsApi implements CampaignsApi {
  ...
  Future<List<CampaignOut>> listCampaignsV1CampaignsGet({
    ...
    final _options = _setStreamType<List<CampaignOut>>(
    ...
    late List<CampaignOut> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => CampaignOut.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<CampaignOut> createCampaignV1CampaignsPost({
    ...
    final _options = _setStreamType<CampaignOut>(
    ...
    late CampaignOut _value;
    try {
      _value = CampaignOut.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<List<CampaignOut>> listMyCampaignsV1CampaignsMineGet() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<List<CampaignMemberOut>> listMembersV1CampaignsCampaignIdMembersGet({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<CampaignMemberOut>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/campaigns/${campaignId}/members',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<CampaignMemberOut> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                CampaignMemberOut.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  Future<OkOut> addMemberV1CampaignsCampaignIdMembersPost({
    required String campaignId,
    required CampaignMemberAdd body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<void> removeMemberV1CampaignsCampaignIdMembersUserIdDelete({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/campaigns/${campaignId}/members/${userId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
