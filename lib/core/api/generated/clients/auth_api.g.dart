...
class _AuthApi implements AuthApi {
  ...
  @override
  Future<void> logoutV1AuthLogoutPost({LogoutRequest? body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<void> deleteOwnAccountV1AuthMeDelete({
    required DeleteAccountRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<UserOut> getMeV1AuthMeGet() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<UserOut> updateMeV1AuthMePatch({required UserUpdate body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<AvatarOut> uploadMyAvatarV1AuthMeAvatarPost({
    ...
    final _options = _setStreamType<AvatarOut>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late AvatarOut _value;
    try {
      _value = AvatarOut.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<UserProfileOut> getMyProfileV1AuthMeProfileGet() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<UserProfileOut>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/auth/me/profile',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late UserProfileOut _value;
    try {
      _value = UserProfileOut.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<Token> refreshV1AuthRefreshPost({required RefreshRequest body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<TotpConfirmOut> totpConfirmV1AuthTotpConfirmPost({
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<TotpConfirmOut>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late TotpConfirmOut _value;
    try {
      _value = TotpConfirmOut.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<TotpSetupOut> totpSetupV1AuthTotpSetupPost() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TotpSetupOut>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/auth/totp/setup',
    ...
    final _result = await _dio.fetch<Map<String, Object?>>(_options);
    late TotpSetupOut _value;
    try {
      _value = TotpSetupOut.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
