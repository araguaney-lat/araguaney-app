...
class _CatalogApi implements CatalogApi {
  ...
  Future<List<RxNormSuggestion>> rxnormSearchV1CatalogRxnormGet({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<RxNormSuggestion>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/catalog/rxnorm',
    ...
    late List<RxNormSuggestion> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => RxNormSuggestion.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
