...
part of 'product_types_api.dart';
...
class _ProductTypesApi implements ProductTypesApi {
  _ProductTypesApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ProductTypeOut> createProductTypeV1ProductTypesPost({
    required ProductTypeCreate body,
  }) async {
    final _extra = <String, dynamic>{};
  ...
  Future<List<ProductTypeOut>> searchProductTypesV1ProductTypesSearchGet({
    ...
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'q': q, r'category': category};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProductTypeOut>>(
  ...
  Future<ProductTypeOut> updateProductTypeV1ProductTypesPtIdPatch({
    required String ptId,
    required ProductTypeUpdate body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<List<ProductGtinOut>> listProductGtinsV1ProductTypesPtIdGtinsGet({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProductGtinOut>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/product-types/${ptId}/gtins',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<ProductGtinOut> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ProductGtinOut.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  Future<void> unlinkProductGtinV1ProductTypesPtIdGtinsGtinIdDelete({
    ...
    final _options = _setStreamType<void>(
      Options(method: 'DELETE', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/v1/product-types/${ptId}/gtins/${gtinId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
